...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "gray28"))))
 '(font-lock-constant-face ((t (:foreground "purple3"))))
 ...
 '(font-lock-type-face ((t (:foreground "cyan1" :slant italic))))
 ...
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "gray80" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "apple" :family "Monaco")))))

(provide-theme 'inming)
